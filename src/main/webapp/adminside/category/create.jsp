...
<head>
    <meta charset="UTF-8">
    <title>Create Category | Planzone Admin</title>
...
<main class="flex-1 p-8">
    <h1 class="text-2xl font-bold text-orange-600 mb-6">
        <i class="fa-solid fa-layer-group mr-2"></i> Create New Category
    </h1>

    <form method="post" action="${pageContext.request.contextPath}/admin/category" class="bg-white w-full p-6 rounded-lg shadow-md">
