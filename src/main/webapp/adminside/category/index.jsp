...
<head>
    <meta charset="UTF-8">
    <title>Manage Categories | Planzone Admin</title>
...
<main class="flex-1 p-8">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-orange-600">
            <i class="fa-solid fa-layer-group mr-2"></i> Manage Categories
        </h1>
        <a href="${pageContext.request.contextPath}/admin/category?action=create"
           class="bg-orange-500 text-white px-4 py-2 rounded-lg text-sm hover:bg-orange-600 transition">
            <i class="fa-solid fa-plus mr-1"></i> Create Category
        </a>
    </div>
        ...
        <table class="w-full text-sm">
            ...
            <tbody id="categoryTable">
                <c:forEach var="category" items="${categories}">
                    <tr class="border-t">
                        <td class="py-3 px-4">${category.categoryId}</td>
                        <td class="py-3 px-4">${category.name}</td>
                        <td class="py-3 px-4">
                            <a href="${pageContext.request.contextPath}/admin/category?action=edit&id=${category.categoryId}"
                               class="text-blue-500 hover:text-blue-700 mr-3"><i class="fa-solid fa-pen-to-square"></i></a>
                            <a href="javascript:void(0);" onclick="confirmDelete('${pageContext.request.contextPath}/admin/category?action=delete&id=${category.categoryId}')"
