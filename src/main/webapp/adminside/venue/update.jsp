...
<head>
    <meta charset="UTF-8">
    <title>Update Venue | Planzone Admin</title>
...
<main class="flex-1 p-8">
    <h1 class="text-2xl font-bold text-orange-600 mb-6">
        <i class="fa-solid fa-building-pen mr-2"></i> Update Venue
    </h1>
    ...
    <form method="post" action="${pageContext.request.contextPath}/admin/venue" class="bg-white w-full p-6 rounded-lg shadow-md">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="${venue.name}" required
            ...
            <div>
                ...
                <input type="number" name="capacity" id="capacity" min="1" value="${venue.capacity}" required
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400">
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="address" id="address" rows="3" required
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400">${venue.address}</textarea>
            </div>
        </div>
